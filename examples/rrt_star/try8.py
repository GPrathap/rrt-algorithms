...
# location  = "/home/geesara/Desktop/tmp/"
# index = 0
#
...
# plot.plot_start(start_and_end_pose[0:3], "#A569BD", "$X_{start}, X_{goal}$")
# plot.plot_goal(start_and_end_pose[3:6], "#A569BD", "")
# plot.draw_ellipsoid(start_and_end_pose)
# plot.draw(auto_open=True)
# plt.show()


path_rrt = np.load('/home/geesara/Desktop/file_name.npy')
# path_rrt = np.load('/home/geesara/Desktop/frame06.ply')
